...
--synchro summon
	Synchro.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0xf25),1,1,Synchro.NonTunerEx(Card.IsSetCard,0xf25),1,99)
	c:EnableReviveLimit()
...
function s.pmfilter(c,sc)
	...
	or c:IsType(TYPE_RITUAL,sc,SUMMON_TYPE_SYNCHRO))
end
