...
function s.initial_effect(c)
	...
	c:RegisterEffect(e4)
	--Set itself from GY if a "Impish" monster is normal summoned to your field
...
function s.filter(c,e,tp)
	return c:IsCanBeSpecialSummoned(e,0,tp,false,false) and c:IsRace(RACE_FIEND) and c:IsLevelBelow(4)
end
...
function s.cfilter(c,tp)
	return c:IsSetCard(0xf19) and c:IsControler(tp) and c:IsSummonLocation(LOCATION_EXTRA)
end
