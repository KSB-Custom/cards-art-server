...
function s.filter(c,e,tp)
	return c:IsSetCard(0x759) and c:IsAttributeExcept(ATTRIBUTE_EARTH) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
...
function s.filter(c,e,tp)
	return c:IsSetCard(0x759) and c:IsAttributeExcept(ATTRIBUTE_EARTH) and c:IsCanBeSpecialSummoned(e,100,tp,false,false)
end
