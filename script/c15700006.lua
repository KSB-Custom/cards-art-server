...
function s.initial_effect(c)
	...
	e2:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x7c9))
	e2:SetValue(500)
	c:RegisterEffect(e2)
	--defup
	local e3=e2:Clone()
...
function s.filter(c)
	return c:IsSetCard(0x7c9) and c:IsAbleToDeck() and not c:IsPublic()
end
...
function s.cfilter(c)
	return c:IsSetCard(0x7c9) and c:IsAbleToRemoveAsCost() and not c:IsCode(id)
