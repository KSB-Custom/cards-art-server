...
function s.initial_effect(c)
	c:EnableReviveLimit()
	Synchro.AddProcedure(c,aux.FilterBoolFunctionEx(Card.IsSetCard,0xf19),1,1,Synchro.NonTuner,1,99)
	--negate
...
function s.spfilter1(c,e,tp)
	local lv=c:GetLevel()
	return lv>0 and lv<12 and c:IsSetCard(0xf19) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
